...
const URIPermissions = 'http://localhost:4747/permissions/'
const URIUsers = 'http://localhost:4747/users/'
const CompPermissionUserEdit = () => {
        ...
        const getPermissionUserById = async () => {
...
export default CompPermissionUserEdit